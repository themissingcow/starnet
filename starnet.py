...
#                     G           D      #
learning_rates = [0.0000002, 0.00000005] # Learning rates: the first is for generator, the second is for discriminator. 
                                         # In the beginning of training suitable values are about 0.0002 and then can be made smaller
                                         # as the model gets better. Current values ([0.0000002, 0.00000005]) are for fine-tuning.
